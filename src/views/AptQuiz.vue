    ...
    <div class="arrays-quiz">
      ...
      <div v-if="!quizStarted" class="quiz-intro">
        <div class="intro-content">
          <h1 class="intro-title">Aptitute and Reasoning Quiz</h1>
          <p class="intro-message">
            Welcome to the A&R quiz!<br />
            Test your knowledge on A&R and see how much you really know.
          </p>
  ...
  export default {
    ...
    methods: {
      async fetchQuestions() {
        this.loading = true;
        try {
          const response = await axios.get("http://localhost:5000/apt-quiz-questions"); // Updated endpoint for algorithms quiz
