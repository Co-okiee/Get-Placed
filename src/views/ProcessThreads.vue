<template>
    <div class="os-container">
      ...
      <h3 class="sub-sub-title">Memory Management – Mapping Virtual Addresses to Physical Addresses</h3>
      <p class="content">
...
const topic = "Process Threads";
const subtopic = "Process Threads concept";
