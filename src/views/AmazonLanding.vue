<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Amazon</h1>
      
      <div class="company-description">
        <p>Amazon is a global technology leader in e-commerce, cloud computing, digital streaming, and artificial intelligence. Known for innovative solutions, AWS cloud services, and transformative digital technologies.</p>
      </div>
    ...
    return {
      resources: [
      {
        ...
        },
        {
          ...
          icon: '🤖',
          title: 'System Design',
          description: 'Learn to design systems for scalability',
          route: '/aisystem.html'
        },
        {
          id: 3,
