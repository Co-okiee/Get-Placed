<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Accenture</h1>
      
      <div class="company-description">
        <p>Accenture is a global professional services company specializing in strategy, consulting, digital, technology, and operations. Known for innovative solutions and transforming businesses through cutting-edge technology and strategic insights.</p>
      </div>
