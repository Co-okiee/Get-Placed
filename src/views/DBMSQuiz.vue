    ...
    <div class="arrays-quiz">
      ...
      <div v-if="!quizStarted" class="quiz-intro">
        <div class="intro-content">
          <h1 class="intro-title">DBMS Quiz</h1>
          <p class="intro-message">
            Welcome to the DBMS quiz!<br />
            Test your knowledge on DBMS and see how much you really know.
          </p>
  ...
  export default {
    ...
    methods: {
      async fetchQuestions() {
        this.loading = true;
        try {
          const response = await axios.get("http://localhost:5000/dbms-quiz-questions"); // Updated endpoint for algorithms quiz
