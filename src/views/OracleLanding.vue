  ...
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      ...
      <div class="company-description">
        <p>Oracle Corporation is a multinational technology company specializing in developing and marketing database software, cloud engineered systems, and enterprise software products. Known for innovative database technologies and comprehensive cloud solutions.</p>
      </div>
  ...
  data() {
    return {
      resources: [
      {
          ...
          description: 'Master Trees, Graphs, and ADS',
          route: '/aids.html'
        },
        {
          id: 2,
          icon: '🤖',
          title: 'DBMS',
          description: 'Tackle SQL-based challenges',
          route: '/aidbms.html'
        },
        {
          id: 3,
          icon: '🔧',
          title: 'System Design',
          description: 'Scalable system and software architecture',
          route: '/aisystem.html'
        },
        {
          id: 4,
