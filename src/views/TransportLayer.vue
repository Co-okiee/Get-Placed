<template>
    <div class="transport-container">
      ...
      <div class="diagram-container">
        <img src="src\assets\study_imgs\transport1.jpg" alt="TCP Congestion Control Diagram" class="imageedit" />
        <img src="src\assets\study_imgs\transport2.png" alt="User Datagram Protocol Overview Diagram" class="imageedit" />
        <img src="src\assets\study_imgs\transport3.jpg" alt="Multiplexing and Demultiplexing Diagram" class="imageedit" />
      </div>
