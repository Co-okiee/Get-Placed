<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Cognizant</h1>
      
      <div class="company-description">
        <p>Cognizant is a multinational IT services and consulting company, specializing in digital, technology, and business transformation services. Renowned for delivering innovative solutions across various industries globally.</p>
      </div>
