<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Deloitte</h1>
      
      <div class="company-description">
        <p>Deloitte is a global professional services firm offering audit, consulting, financial advisory, risk management, tax, and legal services. Renowned for digital transformation, strategic insights, and innovative business solutions.</p>
      </div>
