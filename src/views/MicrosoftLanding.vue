<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Microsoft</h1>
      
      <div class="company-description">
        <p>Microsoft is a global technology company known for developing, manufacturing, and selling computer software, consumer electronics, and personal computers. A leader in cloud computing, productivity tools, and enterprise solutions.</p>
      </div>
    ...
    return {
      resources: [
      {
        ...
        },
        {
          ...
          icon: '🤖',
          title: 'System Design',
          description: 'Design APIs and distributed systems.',
          route: '/aisystem.html'
        },
        {
          id: 3,
