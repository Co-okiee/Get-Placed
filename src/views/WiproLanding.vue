<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Wipro</h1>
      
      <div class="company-description">
        <p>Wipro Limited is a global information technology, consulting, and business process services company. Known for delivering innovative digital transformation solutions and helping enterprises adapt to emerging technologies.</p>
      </div>
