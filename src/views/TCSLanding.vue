<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Tata Consultancy Services (TCS)</h1>
      
      <div class="company-description">
        <p>TCS is a leading global IT services and consulting company, known for its comprehensive digital transformation solutions, robust software development, and innovative technology services across various industries worldwide.</p>
      </div>
    ...
    return {
      resources: [
        ...
        },
        {
          ...
          description: 'SQL, NoSQL, and data modeling concepts',
          route: '/aidbms.html'
        },
        {
          id: 4,
          ...
          description: 'Learn process scheduling',
          route: '/aios.html'
        },
        {
          id: 5,
