<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">NVIDIA</h1>
      
      <div class="company-description">
        <p>NVIDIA is a world leader in graphics processing and AI computing. Renowned for groundbreaking GPU technologies, AI innovations, and cutting-edge solutions in gaming, data centers, and artificial intelligence.</p>
      </div>
    ...
    return {
      resources: [
      {
        ...
        },
        {
          ...
          icon: '🤖',
          title: 'System Design',
          description: 'Design robust, low-level systems.',
          route: '/aisystem.html'
        },
        {
          id: 3,
