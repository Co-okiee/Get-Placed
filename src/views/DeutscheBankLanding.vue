<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Deutsche Bank</h1>
      
      <div class="company-description">
        <p>Barclays is a British multinational investment bank and financial services company headquartered in London. It provides various financial services, including personal banking, corporate banking, and investment management.</p>
      </div>
      ...
      resources: [
        {
          ...
          description: 'Practice core data structure concepts',
          route: '/aids.html'
        },
        {
          id: 2,
          icon: '🗃️',
          title: 'DBMS',
          description: 'Database management system challenges',
          route: '/aidbms.html'
        },
        {
          id: 3,
        ...
        },
        {
          ...
          description: 'Learn about protocols and security.',
          route: '/aicnt.html'
        },
        {
          id: 5,
