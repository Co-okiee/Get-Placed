<template>
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      <h1 class="company-title">Siemens</h1>
      
      <div class="company-description">
        <p>Siemens is a global powerhouse in electrification, automation, and digitalization. Known for innovative industrial technologies, smart infrastructure solutions, and cutting-edge engineering across multiple sectors.</p>
      </div>
    ...
    return {
      resources: [
      {
        ...
        },
        {
          ...
          description: 'Study protocols and secure communication',
          route: '/aicnt.html'
        },
        {
          id: 5,
