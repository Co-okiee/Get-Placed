  ...
  <div class="landing-container">
    ...
    <div class="content-wrapper">
      ...
      <div class="company-description">
        <p>Google is a global technology leader specializing in internet-related services and products, including search, cloud computing, software, and hardware. Known for innovative solutions and cutting-edge technological research.</p>
      </div>
    ...
    return {
      resources: [
      {
        ...
        },
        {
          ...
          icon: '📊',
          title: 'CNT',
          description: 'Learn load balancing, CDN, and routing principles.',
          route: '/aicnt.html'
        },
        {
          id: 5,
